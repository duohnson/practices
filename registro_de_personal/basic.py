...
while True:
    ...
    try:
        ...
        if seleccion == 1:
            print("Ingresando...\n")
            registrar() # Al seleccionar 1 llamamos al metodo para registrar informacion.
            ...
            usuario_encontrado = Usuario.cargar_desde_json(ids_buscar) # Aca definimos que, el usuario encontrado es la variable del resultado de, en la clase usuario, llamamos al metodo cargar datos, para 
